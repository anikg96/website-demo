  ...
  return (
    ...
    >
        ...
        <div class="flex flex-wrap gap-0">
            <div onClick={() => handleOnOpen(rafael)}
            class="relative w-1/2 md:w-1/4 lg:w-1/4 text-center hover:transform hover:scale-125 hover:rounded transition hover:z-50 hover:cursor-pointer duration-50 ease-in-out">
            ...
            <div onClick={() => handleOnOpen(rebekka)}
            class="relative w-1/2 md:w-1/4 lg:w-1/4 text-center hover:transform hover:scale-125 hover:rounded transition hover:z-50 hover:cursor-pointer duration-50 ease-in-out">
            ...
            <div onClick={() => handleOnOpen(sikander)}
            class="relative w-1/2 md:w-1/4 lg:w-1/4 text-center hover:transform hover:scale-125 hover:rounded transition hover:z-50 hover:cursor-pointer duration-50 ease-in-out">
            ...
            <div onClick={() => handleOnOpen(konrad)}
            class="relative w-1/2 md:w-1/4 lg:w-1/4 text-center hover:transform hover:scale-125 hover:rounded transition hover:z-50 hover:cursor-pointer duration-50 ease-in-out">
